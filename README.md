...
**`v3.2.0`** · GTK4 + libadwaita · X11 & Wayland · desktop + NetHunter mobile
...
#   covers: settings round-trip, the self-edit write path (ast gate +
#   immutable guardrail + backup + atomic replace), the ChatStore SQLite
#   layer, and the CVE auto-chain (NVD/KEV/EPSS enrichment + ranking).
