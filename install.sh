...
OPTIONAL_FILES=(org.thepriest.basilisk.svg basilisk-dragon.svg basilisk-watermark.png basilisk-cross.svg basilisk-avatar.png basilisk-logo.png basilisk-priest.png basilisk-btn-settings.png basilisk-btn-bell.png basilisk-btn-terminal.png basilisk-btn-minimise.png basilisk-btn-close.png basilisk-btn-attach.png basilisk-btn-camera.png basilisk-btn-suggest.png basilisk-btn-sound.png basilisk_btn_art.py)
...
# app finds them at runtime (best-effort — the chat simply has no watermark if
# the file isn't there).
for _art in basilisk-watermark.png basilisk-dragon.svg basilisk-cross.svg basilisk-avatar.png basilisk-logo.png basilisk-priest.png basilisk-btn-settings.png basilisk-btn-bell.png basilisk-btn-terminal.png basilisk-btn-minimise.png basilisk-btn-close.png basilisk-btn-attach.png basilisk-btn-camera.png basilisk-btn-suggest.png basilisk-btn-sound.png; do
